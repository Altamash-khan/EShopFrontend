...
<div class="about-section">
		<div class="container">
			<div class="site-title text-center">
				<h3>About Us</h3>
				<p>We Have Opened Our New Branch In <b>Pheonix Kurla(W)</b> </p>
			</div>
			<div class="about-inner-section">	
				...
				<div class="col-md-6 about-inner-column">
					...
					<p>Currently We Make Our Website For Online Shopping With Cash On Delivery And Free Home Delivery on Around Mumbai City</p>
					<h3>Our Other Branches in Mumbai</h3>
					<ul>
						<li>Grant Road</li>
						<li>Sewri</li>
						<li>Andheri</li>
